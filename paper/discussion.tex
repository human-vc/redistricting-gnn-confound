% Discussion section for the confound-isolated GNN redistricting-outlier paper.
% Drop-in: \input{discussion} from the main document; uses references.bib.
% Prose grounded in the 2026-08-09 mechanism research pass; every empirical
% number traces to outputs_real_{NC,PA,MD}/ and outputs_why/.
