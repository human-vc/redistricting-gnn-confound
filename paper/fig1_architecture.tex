% Fig 2: method schematic, redrawn as a VERTICAL flow so it is tall (not flat)
% and the block text stays legible at single-column width. Okabe-Ito colors,
% Stealth arrows, dashed group box, newtx fonts.
