% Table II: multi-election robustness. How often each classical statistic flags
% the enacted plan as an outlier across all available statewide races, vs the
% geometry detector's single election-invariant verdict.
\begin{table}[t]
